...
public class SkylinDataSource implements DataSource{
	...
	ArrayList<SkylinConnection> allConnections = new ArrayList<SkylinConnection>();
	ArrayList<SkylinConnection> allConnectionsSnapShot = new ArrayList<SkylinConnection>();
	int currentSize;
		...
		while (true)
		{
			...
			if (ret != null)
			{
				try
				{
					...
					ret.inUseSince = System.currentTimeMillis();
					ret.requesterStackTrace = Thread.currentThread().getStackTrace();
					return ret;
				}
	...
	public List<SkylinConnection> getAllConnectionsSnapShot()
	{
		return (List<SkylinConnection>) allConnectionsSnapShot.clone();
	}
	...
	public void createConnectionSnapShot() {
		allConnectionsSnapShot = (ArrayList<SkylinConnection>) allConnections.clone();
	}
